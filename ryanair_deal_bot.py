...
async def handle_menu_button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.get("awaiting_city_search"):
        ...
        try:
            ...
            return
        await update.message.reply_text(
            "Any dog or small kid coming? Also pick hotels vs apartments below, then Search:",
...
async def handle_callback_button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("setmax:"):
        ...
        await context.bot.send_message(
            chat_id=query.message.chat_id,
            text="Any dog or small kid coming? Also pick hotels vs apartments below, then Search:",
